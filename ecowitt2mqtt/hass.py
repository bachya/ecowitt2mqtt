...
DATA_POINTS = {
    ...
    DATA_POINT_HUMIDITYIN: ("mdi:water-percent", "inches"),
    ...
    DATA_POINT_SOILHUM10: ("mdi:water-percent", "%"),
    DATA_POINT_SOILHUM1: ("mdi:water-percent", "%"),
    DATA_POINT_SOILHUM2: ("mdi:water-percent", "%"),
    DATA_POINT_SOILHUM3: ("mdi:water-percent", "%"),
    DATA_POINT_SOILHUM4: ("mdi:water-percent", "%"),
    DATA_POINT_SOILHUM5: ("mdi:water-percent", "%"),
    DATA_POINT_SOILHUM6: ("mdi:water-percent", "%"),
    DATA_POINT_SOILHUM7: ("mdi:water-percent", "%"),
    DATA_POINT_SOILHUM8: ("mdi:water-percent", "%"),
    DATA_POINT_SOILHUM9: ("mdi:water-percent", "%"),
