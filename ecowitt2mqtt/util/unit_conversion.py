...
class IlluminanceConverter(BaseUnitConverter):
    ...
    DEFAULT_UNITS = {
        UNIT_SYSTEM_IMPERIAL: ILLUMINANCE_WATTS_PER_SQUARE_METER,
        UNIT_SYSTEM_METRIC: ILLUMINANCE_WATTS_PER_SQUARE_METER,
    }
...
class PrecipitationRateConverter(BaseUnitConverter):
    ...
    DEFAULT_UNITS = {
        UNIT_SYSTEM_IMPERIAL: PRECIPITATION_MILLIMETERS_PER_HOUR,
        UNIT_SYSTEM_METRIC: PRECIPITATION_INCHES_PER_HOUR,
    }
...
class PressureConverter(BaseUnitConverter):
    ...
    DEFAULT_UNITS = {
        ...
        UNIT_SYSTEM_METRIC: PRESSURE_PA,
    }
...
class VolumeConverter(BaseUnitConverter):
    ...
    DEFAULT_UNITS = {
        UNIT_SYSTEM_IMPERIAL: VOLUME_POUNDS_PER_CUBIC_FOOT,
        UNIT_SYSTEM_METRIC: VOLUME_GRAMS_PER_CUBIC_METER,
    }
