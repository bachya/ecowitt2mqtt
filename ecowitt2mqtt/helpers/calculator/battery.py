...
from ecowitt2mqtt.const import (
    ...
    DATA_POINT_BATTERY8,
    DATA_POINT_CO2_BATT,
    DATA_POINT_LEAFBATT1,
    DATA_POINT_LEAFBATT2,
    DATA_POINT_LEAFBATT3,
    DATA_POINT_LEAFBATT4,
    DATA_POINT_LEAFBATT5,
    DATA_POINT_LEAFBATT6,
    DATA_POINT_LEAFBATT7,
    DATA_POINT_LEAFBATT8,
...
BATTERY_STRATEGY_MAP = {
    ...
    DATA_POINT_LEAFBATT1: BatteryStrategy.NUMERIC,
    DATA_POINT_LEAFBATT2: BatteryStrategy.NUMERIC,
    DATA_POINT_LEAFBATT3: BatteryStrategy.NUMERIC,
    DATA_POINT_LEAFBATT4: BatteryStrategy.NUMERIC,
    DATA_POINT_LEAFBATT5: BatteryStrategy.NUMERIC,
    DATA_POINT_LEAFBATT6: BatteryStrategy.NUMERIC,
    DATA_POINT_LEAFBATT7: BatteryStrategy.NUMERIC,
    DATA_POINT_LEAFBATT8: BatteryStrategy.NUMERIC,
