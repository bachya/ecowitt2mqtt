...
async def test_publish(config, device_data, ecowitt, request, setup_asyncio_mqtt):
    ...
    publisher.client.publish.assert_awaited_with(
        TEST_MQTT_TOPIC,
        b'{"runtime": 319206.0, "tempin": 79.5, "humidityin": 31.0, "baromrel": 24.74, "baromabs": 24.74, "temp": 19.1, "humidity": 34.0, "winddir": 139.0, "windspeed": 20.89, "windgust": 1.12, "maxdailygust": 8.05, "solarradiation": 264.61, "uv": 2.0, "rainrate": 0.0, "eventrain": 0.0, "hourlyrain": 0.0, "dailyrain": 0.0, "weeklyrain": 0.0, "monthlyrain": 2.177, "yearlyrain": 4.441, "lightning_num": 13.0, "lightning": 0.6, "lightning_time": "2022-04-20T17:17:17+00:00", "wh65batt": "OFF", "dewpoint": -4.7, "feelslike": 2.7, "frostpoint": -3.3, "frostrisk": "Unlikely", "heatindex": 12.3, "humidityabs": 0.0, "humidityabsin": 0.0, "safe_exposure_time_skin_type_1": 83.3, "safe_exposure_time_skin_type_2": 100.0, "safe_exposure_time_skin_type_3": 133.3, "safe_exposure_time_skin_type_4": 166.7, "safe_exposure_time_skin_type_5": 266.7, "safe_exposure_time_skin_type_6": 433.3, "simmerindex": null, "simmerzone": null, "solarradiation_lux": 33494.9, "solarradiation_perceived": 90.0, "thermalperception": "Dry", "windchill": 2.7}',
    )
